...
//Save for later
Route::delete('/saveLater/destroy/{product}', 'SaveLaterController@destroy')->name('saveLater.destroy');
//Move to cart
Route::post('/cart/moveToCart/{product}', 'SaveLaterController@moveToCart')->name('moveToCart');
